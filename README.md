...
The code follows the same method taught in primary school and can record operation history with Python logging:
...
Use `show_steps=True` and configure Python logging when you want to see each addition step:
...
The CLI intentionally stays simple and uses Python core features such as `input()`, `print()`, and `logging`.
